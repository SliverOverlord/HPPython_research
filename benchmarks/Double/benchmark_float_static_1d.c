...
void mat_mult_1d(float mat1[1000000], int mat1_row, int mat1_col, 
                 float mat2[1000000], int mat2_row, int mat2_col,
                 float output_mat[1000000], int output_mat_row, int output_mat_col);

int main(){
    static float list_mat[ARR_SIZE];
    static float list_mat2[ARR_SIZE];
    static float output_mat[ARR_SIZE];
    ...
    for (int i = 0; i < ARR_SIZE; i++)    
        fscanf(fp, "%f", &list_mat[i]);
        
           
    for (int i = 0; i < ARR_SIZE; i++)    
        fscanf(fp2, "%f", &list_mat2[i]);
