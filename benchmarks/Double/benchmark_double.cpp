...
void mat_mult(double ** mat1, double ** mat2, double ** output_mat);

int main(){
    
    double ** list_mat;
    list_mat = new double*[1000];

    double ** list_mat2;
    list_mat2 = new double*[1000];

    double ** output_mat;
    output_mat = new double*[1000];

    for (int i = 0; i < 1000; i++)
    {
        list_mat[i] = new double[1000];
        list_mat2[i] = new double[1000];
        output_mat[i] = new double[1000];
    }
