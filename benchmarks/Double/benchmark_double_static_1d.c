...
void mat_mult_1d(double mat1[1000000], int mat1_row, int mat1_col, 
                 double mat2[1000000], int mat2_row, int mat2_col,
                 double output_mat[1000000], int output_mat_row, int output_mat_col);

int main(){
    static double list_mat[ARR_SIZE];
    static double list_mat2[ARR_SIZE];
    static double output_mat[ARR_SIZE];
