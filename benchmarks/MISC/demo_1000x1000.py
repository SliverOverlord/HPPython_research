...
def main():
    ...
    mat1 = [float(i) for i in range(1, 1000001)]
    mat2 = [float(i) for i in range(1, 1000001)]
    output_mat = [0 for i in range(1,1000001)]
    ...
    result = mpi_matmul(mat1, 1000, 1000, mat2, 1000, 1000, output_mat, 1000, 1000);
...
def mpi_send(data, destination, tag):
    global _c_pylib
