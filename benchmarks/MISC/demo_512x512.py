...
def main():
    ...
    mat1 = [float(i) for i in range(1, 262145)]
    mat2 = [float(i) for i in range(1, 262145)]
    output_mat = [0 for i in range(1, 262145)]
    ...
    result = mpi_matmul(mat1, 512, 512, mat2, 512, 512, output_mat, 512, 512);
    print("Total time taken: {}".format(time.clock() - startTime))

    print("Expected length = 512; Actual length = ", len(result))
